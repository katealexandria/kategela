...
import com.example.database.CustomerDB;
import com.example.object.Customer;

public class AddUpdateCustomer extends Activity {
	...
	public void addCustomer(View view) {
		if ((Is_Valid_Name(textFirstName) == true)
			...
			customerDB.AddCustomer(new Customer(textFirstName.getText().toString(), textLastName.getText().toString(),
					textAddress.getText().toString(), textAddressLandMark.getText().toString(),
					textTelNo.getText().toString(), textMobileNo.getText().toString()));
	...
	public void updateCustomer(View view) {
		if ((Is_Valid_Name(textFirstName) == true)
				...
				&& (Is_Valid__Number(7, 10, textTelNo) == true)
				&& (Is_Valid__Number(11, 12, textMobileNo) == true)) {
			customerDB.UpdateCustomer(new Customer(CUSTOMER_ID, textFirstName.getText().toString(), textLastName.getText().toString(),
					textAddress.getText().toString(), textAddressLandMark.getText().toString(),
					textTelNo.getText().toString(), textMobileNo.getText().toString()));
	...
	public void viewAllCustomer(View view) {
		Intent view_user = new Intent(AddUpdateCustomer.this,
				Main_Screen.class);
