...
public class CloseDay extends Activity {
	...
	public void Initialize(){
		...
		txtRegister.addTextChangedListener(new TextWatcher(){
	        public void afterTextChanged(Editable s) {
	        	...
	        	if((Math.round(val * 100)/100) == (Math.round(register * 100)/100))
	        		return;
	        	register = val;
	...
	public void endDay(View view) {
		...
		summary.user = user;
		summary.cash_expected = cashExpected;
	...
	public void clickAmount(View view){
		...
		double append = 0;
		switch(id){
			case R.id.cdP1: append = 1; break;
			case R.id.cdP10: append = 10; break;
			case R.id.cdP100: append = 100; break;
			case R.id.cdP1000: append = 1000; break;
			case R.id.cdP20: append = 20; break;
			case R.id.cdP200: append = 200; break;
			case R.id.cdP25c: append = 0.25; break;
			case R.id.cdP5: append = 5; break;
			case R.id.cdP50: append = 50; break;
			case R.id.cdP500: append = 500; break;
		}
		counted += append;
		deposit += append;
		SetAmounts();
	...
	public void clickDigit(View view){
		...
		int id = view.getId();
		switch(id){
			case R.id.btn0n: amt += "0"; break;
			case R.id.btn1n: amt += "1"; break;
			case R.id.btn2n: amt += "2"; break;
			case R.id.btn3n: amt += "3"; break;
			case R.id.btn4n: amt += "4"; break;
			case R.id.btn5n: amt += "5"; break;
			case R.id.btn6n: amt += "6"; break;
			case R.id.btn7n: amt += "7"; break;
			case R.id.btn8n: amt += "8"; break;
			case R.id.btn9n: amt += "9"; break;
			case R.id.btnClr: amt = "000"; break;
			case R.id.btnNeg: negate = true; break;
		}
