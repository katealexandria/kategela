...
public class PrintReceipt extends Activity {
	...
	private void Initialize(){
		...
		switch(Sync.lastSale.orderType){
			case 1: temp.setText("Dine-in"); break;
			case 2: temp.setText("Take-out"); break;
			case 3: temp.setText("Delivery"); break;
		}		
		...
		temp.setText("Customer: " + Sync.lastSale.customer.first_name + " " + Sync.lastSale.customer.last_name);
	...
	private void InflateItems(){
		...
		for (Item item : Sync.lastSale.items) {
			...
			TableRow newRow = (TableRow) vi.inflate(
					R.layout.receipt_item_row, null);
